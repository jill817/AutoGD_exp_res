    ...
    struct opt_solver::imp
    {
        ...
        */
        ...
        std::ostream &display_constraint(std::ostream &out, constraint const &cons) const
        {
            if (cons.m_lower&&cons.m_upper)
            {
                // display_constraint_lower_upper(out, cons);
            }
            else
            {
                if (cons.m_lower)
        ...
        std::ostream &display_constraint_lower_upper(std::ostream &out, constraint const &cons) const
        {
            out << cons.m_name + "_equal: ";
        ...
        void write_lp_file(std::string str) {
            std::cout << "write lp file: " << str << std::endl;
            std::ofstream outFile(str);
            if (!outFile.is_open()) {
                std::cerr << "Error: cannot open file " << str << " for writing!" << std::endl;
                return;
            }
            outFile << "Minimize\n";
            outFile << " obj: ";
